<template>
    <div class="bg-white bg-hero" :style="backgroundStyles">
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div
                        ...
                        Announcing our next round of funding. <a href="#"
                            class="font-semibold text-indigo-600"><span
                                class="absolute inset-0" aria-hidden="true" />Read more
                ...
                <div class="text-center">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">Anim aute id magna
...
const backgroundStyles = computed(() => {
    const imgUrl = img('~/assets/img/hero.jpeg', { width: 100 })
